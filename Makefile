.PHONY = default deps build test start-calendar-backend clean start-database start-backoffice-frontend

# Shell to use for running scripts
SHELL := $(shell which bash)
IMAGE_NAME := albansr0309/simple-calendar
SERVICE_NAME := app
MOOC_APP_NAME := calendar
...
# Start calendar backend app
start-calendar-backend: build
